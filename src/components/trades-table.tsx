...
import { MoreHorizontal, TrendingUp, TrendingDown, Clock, CheckCircle, XCircle } from "lucide-react"
...
export function TradesTable({ trades, onEditTrade, onDeleteTrade }: TradesTableProps) {
  ...
  const getTypeBadge = (type: TradeType) => {
    return (
      <Badge 
        ...
        className={type === "BUY" ? "bg-green-100 text-green-800 hover:bg-green-200" : "bg-red-100 text-red-800 hover:bg-red-200"}
      >
        {type === "BUY" ? (
